...
const projectIdeas = [
  {
    ...
    difficulty: 'Advanced',
    category: 'Social',
    productId: 27 // Web3 Facebook Clone
  },
  {
    id: 2,
    ...
    productId: 10 // Custom EVM Blockchain
  },
  {
    id: 3,
  ...
  },
  {
    ...
    difficulty: 'Advanced',
    category: 'Gaming',
    productId: 29 // Solana NFT Marketplace
  },
  {
    id: 6,
    ...
    difficulty: 'Advanced',
    category: 'Storage',
    productId: 5 // Secure File Storage
  },
  {
    id: 7,
    ...
    difficulty: 'Expert',
    category: 'Security',
    productId: 23 // Smart Contract Auditing DApp
  },
  {
    id: 8,
  ...
  },
  {
    ...
    difficulty: 'Advanced',
    category: 'Identity',
    productId: 7 // Digital Identity Verification
  },
  {
    id: 10,
  ...
  },
  {
    ...
    difficulty: 'Advanced',
    category: 'NFT',
    productId: 17 // Complete NFT Marketplace
  },
  {
    id: 12,
  ...
  },
  {
    ...
    difficulty: 'Advanced',
    category: 'Insurance',
    productId: 6 // Insurance Claims DApp
  },
  {
    id: 14,
    ...
    productId: 4 // Supply Chain Management
  },
  {
    id: 15,
    ...
    difficulty: 'Advanced',
    category: 'Prediction',
    productId: 9 // Crowdfunding Platform
  },
  {
    id: 16,
          ...
          {projectIdeas.map((idea) => (
            <Card key={idea.id} className="group bg-gray-800/50 backdrop-blur-lg border-gray-700/50 hover:border-orange-400/50 transition-all duration-500 transform hover:-translate-y-2 hover:scale-105 rounded-2xl overflow-hidden holographic">
              ...
              <CardContent className="pt-0 pb-4">
                ...
                <Link href={`/product/${idea.productId}`}>
